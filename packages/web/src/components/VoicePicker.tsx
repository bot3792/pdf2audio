  ...
  return (
    <div className="flex-1">
      ...
      <button
        ...
        className="w-full flex items-center justify-between rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm shadow-sm hover:border-zinc-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      >
        <span>
      ...
      {expanded && (
        <div className="mt-2 rounded-lg border border-zinc-200 bg-white shadow-lg max-h-80 overflow-y-auto">
          {voiceGroups.map((group) => (
            <div key={group.label}>
              <div className="sticky top-0 bg-zinc-50 px-3 py-1.5 text-xs font-semibold text-zinc-500 uppercase tracking-wider border-b border-zinc-100">
                {group.label}
              </div>
  ...
  return (
    ...
    >
      <button
        ...
        className="shrink-0 h-7 w-7 rounded-full flex items-center justify-center border border-zinc-200 hover:border-blue-400 hover:bg-blue-50 transition-colors"
      ...
      <div className="flex-1 min-w-0">
        <span className="text-sm text-zinc-900">{voice.label}</span>
        <span className="text-xs text-zinc-400 ml-1.5">({voice.gender})</span>
      </div>

      <span className="text-xs font-medium text-zinc-500 tabular-nums">{voice.grade}</span>
